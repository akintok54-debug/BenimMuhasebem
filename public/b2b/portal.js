    ...
    view.addEventListener("click", async e => {
        ...
        try {
            if (b.dataset.preview) {
                ...
                $("productImageBody").innerHTML = product.gorsel ? image(product.gorsel) : `<p>${me.cari.gorunum?.gorsel === true ? "Bu ürüne henüz resim eklenmemiş." : "Bu bayi için ürün resmi gösterimi kapalı."}</p>`;
