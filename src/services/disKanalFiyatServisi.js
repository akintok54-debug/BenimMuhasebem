...
function ideasoftNet(product){const kdv=f.sayi(product.tax??product.taxRate??product.vatRate,'KDV',0,100);const price=f.sayi(product.price1,'Dış fiyat');return {kdv,net:dahil(product.taxIncluded)?f.kdvHaric(price,kdv):price};}
