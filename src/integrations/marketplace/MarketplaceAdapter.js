...
class MarketplaceAdapter {
    ...
    pullProducts() { return this.unsupported("pullProducts"); }
    ...
    updatePrice() { return this.unsupported("updatePrice"); }
    ...
    pullCustomers() { return this.unsupported("pullCustomers"); }
    pullCategories() { return this.unsupported("pullCategories"); }
